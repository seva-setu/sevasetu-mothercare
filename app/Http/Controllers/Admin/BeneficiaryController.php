...
class BeneficiaryController extends Controller{
	...
	*/
	...
	public function update_beficiary_delivery_date($b_id, $due_date) {
		
		$due_list = $this->calculate_due_list($due_date);
		for($i=0; $i<count($due_list); $i++){
			$select_due_list = DB::table('mct_due_list')
								->where('fk_b_id','=',$b_id)
								->where	('fk_action_id','=', $i)
								->update(['dt_intervention_date'=>$due_list[$i]]);
		}
	}

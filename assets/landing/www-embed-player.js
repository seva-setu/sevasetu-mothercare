...
D.prototype.dispose=function(){this.Ga||(this.Ga=!0,this.A())};
...
Wf.prototype.A=function(){Yf(this);Wf.B.A.call(this)};function Zf(a){return G("EXPERIMENT_FLAGS",{})[a]}
...
function ng(a){a.o||(a.o=!0,Ob(a.u,a))}
function kg(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.i=null);return b}
ag.prototype.u=function(){for(var a;a=kg(this);)lg(this,a,this.b,this.l);this.o=!1};
...
P.prototype.toString=function(){return this.topic};var kh=r("yt.pubsub2.instance_")||new F;F.prototype.subscribe=F.prototype.subscribe;F.prototype.unsubscribeByKey=F.prototype.ha;F.prototype.publish=F.prototype.w;F.prototype.clear=F.prototype.clear;q("yt.pubsub2.instance_",kh,void 0);var lh=r("yt.pubsub2.subscribedKeys_")||{};q("yt.pubsub2.subscribedKeys_",lh,void 0);var mh=r("yt.pubsub2.topicToKeys_")||{};q("yt.pubsub2.topicToKeys_",mh,void 0);var nh=r("yt.pubsub2.isAsync_")||{};q("yt.pubsub2.isAsync_",nh,void 0);
...
y(Nh,D);var Ph=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];g=Nh.prototype;g.Tb=function(a,b){this.isDisposed()||(Qh(this,a),Rh(this,b),this.u&&Sh(this))};
...
function Oh(a){a.u=!1;if(a.qa)for(var b in a.j)a.qa(b,a.j[b]);for(var c in a.la)I(parseInt(c,10));a.la={};a.U=null;a.qa=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=w(a.na,a);a.f.removeEventListener=w(a.be,a);a.f.destroy=w(a.dispose,a);a.f.getLastError=w(a.gd,a);a.f.getPlayerType=w(a.hd,a);a.f.getCurrentVideoConfig=w(a.fd,a);a.f.loadNewVideoConfig=w(a.Tb,a);a.f.isReady=w(a.Ae,a)}
g.Ae=function(){return this.u};
g.na=function(a,b){if(!this.isDisposed()){var c=Th(this,b);if(c){if(!A(this.Uc,a)&&!this.j[a]){var d=ai(this,a);this.U&&this.U(a,d)}this.Z.subscribe(a,c);"onReady"==a&&this.u&&H(ma(c,this.f),0)}}};
...
function ai(a,b){var c="ytPlayer"+b+a.V;a.j[b]=c;l[c]=function(c){var e=H(function(){if(!a.isDisposed()){a.Z.w(b,c);var f=a.la,h=String(e);h in f&&delete f[h]}},0);
gb(a.la,String(e))};
return c}
...
g.A=function(){Zh(this);if(this.K&&this.b)try{this.K.destroy()}catch(b){bc(b)}this.Ia=null;for(var a in this.j)l[this.j[a]]=null;this.Ta=this.b=this.f=null;delete this.i;delete this.o;Nh.B.A.call(this)};var bi={},ci="player_uid_"+(1E9*Math.random()>>>0);function di(a,b){a=v(a)?ke(a):a;b=Xe(b);var c=ci+"_"+ha(a),d=bi[c];if(d)return d.Tb(b),d.f;d=new Nh(a,c);bi[c]=d;J("player-added",d.f);Ub(d,ma(ei,d));H(function(){d.Tb(b)},0);
return d.f}
...
function Qi(a){var b="mouseover"==a.type&&"mouseenter"in Ni||"mouseout"==a.type&&"mouseleave"in Ni,c=a.type in Ni||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=Ni[b],d;for(d in c.ca){var e=Pi(b,d,a.target);e&&!ze(a.relatedTarget,function(a){return a==e},!0)&&c.w(d,e,b,a)}}if(b=Ni[a.type])for(d in b.ca)(e=Pi(a.type,d,a.target))&&b.w(d,e,a.type,a)}}
...
g.xc=function(){this.f=NaN;this.b=Od(ok(this.u,"/pairing/get_screen"),{method:"POST",S:{pairing_code:this.l},timeout:5E3,ba:w(this.se,this),onError:w(this.re,this),Da:w(this.te,this)})};
g.se=function(a,b){this.b=null;var c=b.screen||{};c.dialId=this.i;c.name=this.j;this.w("pairingComplete",new fk(c))};
g.re=function(a){this.b=null;a.status&&404==a.status?this.g>=Ak.length?this.w("pairingFailed",Error("DIAL polling timed out")):(a=Ak[this.g],this.f=H(w(this.xc,this),a),this.g++):this.w("pairingFailed",Error("Server error "+a.status))};
g.te=function(){this.b=null;this.w("pairingFailed",Error("Server not responding"))};function Bk(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";this.avatar=this.username="";this.capabilities=new Sc;this.experiments=new Sc;this.theme="u";if(a){this.id=a.id||a.name;this.name=a.name;this.app=a.app;this.type=a.type||"REMOTE_CONTROL";this.username=a.user||"";this.avatar=a.userAvatarUri||"";this.theme=a.theme||"u";var b=a.capabilities||"";this.capabilities.clear();Tc(this.capabilities,Ia(b.split(","),ma($a,mk)));a=a.experiments||"";this.experiments.clear();Tc(this.experiments,
a.split(","))}}
...
g.xb=function(a,b){Sk(this);wk(this,a);Uk(this,!1);this.w("screenChange");b(a);a.token||Tk(this)};
g.remove=function(a,b){var c=Sk(this);yk(this,a)&&(Uk(this,!1),c=!0);b(a);c&&this.w("screenChange")};
g.ub=function(a,b,c,d){var e=Sk(this),f=this.get(a.id);f?(f.name!=b&&(f.name=b,Uk(this,!1),e=!0),c(a)):d(Error("no such local screen."));e&&this.w("screenChange")};
...
function Yk(a,b){var c;a:if(Za(b)!=Za(a.b))c=!1;else{c=cb(b);for(var d=0,e=c.length;d<e;++d)if(!a.b[c[d]]){c=!1;break a}c=!0}c||(Wk("Updated online screens: "+L(a.b)),a.b=b,a.w("screenChange"));$k(a)}
...
function bl(a){hl(a);a.f=new Rk(a.j);a.f.subscribe("screenChange",w(a.md,a));gl(a);a.g=jk(T("yt-remote-automatic-screen-cache")||[]);hl(a);a.info("Initializing automatic screens: "+lk(a.g));a.b=new Vk(a.j,w(a.W,a,!0));a.b.subscribe("screenChange",w(function(){this.w("onlineScreenChange")},a))}
...
y(il,U);g=il.prototype;g.ob=function(a){this.g=a;this.w("sessionScreen",this.g)};
g.X=function(a){this.isDisposed()||(a&&jl(this,""+a),this.g=null,this.w("sessionScreen",null))};
...
g.A=function(){this.Qb("");il.B.A.call(this)};function kl(a,b){il.call(this,a,b,"CastSession");this.b=null;this.j=0;this.i=null;this.u=w(this.we,this);this.l=w(this.Xd,this);this.j=H(w(function(){ll(this,null)},this),12E4)}
...
g.Ma=function(a){this.info("launchWithParams: "+L(a));this.i=a;this.b&&ml(this)};
g.stop=function(){this.b?this.b.stop(w(function(){this.X()},this),w(function(){this.X(Error("Failed to stop receiver app."))},this)):this.X(Error("Stopping cast device witout session."))};
...
function ll(a,b){I(a.j);if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.g||a.g.id!=b){var c=w(a.ob,a),d=w(a.X,a);a.gc(b,c,d,5)}}else a.X(Error("Waiting for session status timed out."))}
...
g.we=function(a){this.isDisposed()||a||(jl(this,"Cast session died."),this.X())};function ol(a,b){il.call(this,a,b,"DialSession");this.i=this.D=null;this.H="";this.j=null;this.u=t;this.l=NaN;this.K=w(this.ze,this);this.b=t}
y(ol,il);g=ol.prototype;g.Pb=function(a){this.i=a;this.i.addUpdateListener(this.K)};
g.Ma=function(a){this.j=a;this.u()};
g.stop=function(){this.b();this.b=t;I(this.l);this.i?this.i.stop(w(this.X,this,null),w(this.X,this,"Failed to stop DIAL device.")):this.X()};
g.A=function(){this.b();this.b=t;I(this.l);this.i&&this.i.removeUpdateListener(this.K);this.i=null;ol.B.A.call(this)};
function pl(a){a.b=a.F.Hc(a.H,a.f.label,a.f.friendlyName,w(function(a){this.b=t;this.ob(a)},a),w(function(a){this.b=t;
this.X(a)},a))}
g.ze=function(a){this.isDisposed()||a||(jl(this,"DIAL session died."),this.b(),this.b=t,this.X())};
function ql(a){var b={};b.pairingCode=a.H;if(a.j){var c=a.j.currentTime||0;b.v=a.j.videoId;b.t=c}Qk()&&(b.env_useStageMdx=1);return Cd(b)}
...
g.nd=function(a,b){cl(this.F,this.D.receiver.label,a,this.f.friendlyName,w(function(a){a&&a.token?(this.ob(a),b(new chrome.cast.DialLaunchResponse(!1))):this.Lb(b)},this),w(function(a){jl(this,"Failed to get DIAL screen: "+a);
this.Lb(b)},this))};function rl(a,b){il.call(this,a,b,"ManualSession");this.b=H(w(this.Ma,this,null),150)}
y(rl,il);rl.prototype.stop=function(){this.X()};
rl.prototype.Pb=t;rl.prototype.Ma=function(){I(this.b);this.b=NaN;var a=uk(this.F.W(),this.f.label);a?this.ob(a):this.X(Error("No such screen"))};
...
function vl(a,b){return b?Ma(a.g,function(a){return gk(b,a.label)},a):null}
...
g.ye=function(){this.isDisposed()?this.I("Stopping session on disposed cast v2"):this.b?(this.b.stop(),E(this.b),this.b=null):ul("Stopping non-existing session")};
g.requestSession=function(){chrome.cast.requestSession(w(this.qc,this),w(this.Nd,this))};
g.A=function(){this.f.unsubscribe("onlineScreenChange",w(this.Ic,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.i);var a=Zj,b=r("yt.mdx.remote.debug.handlers_");Pa(b||[],a);E(this.b);W.B.A.call(this)};
...
function wl(a,b,c){E(a.b);(a.b=b)?(c?a.w("yt-remote-cast2-receiver-resumed",b.f):a.w("yt-remote-cast2-receiver-selected",b.f),b.subscribe("sessionScreen",w(a.sc,a,b)),b.g?a.w("yt-remote-cast2-session-change",b.g):c&&a.b.Ma(null)):a.w("yt-remote-cast2-session-change",null)}
...
function sl(a){var b=a.f.Gc(),c=a.b&&a.b.f;a=Ja(b,function(a){c&&gk(a,c.label)&&(c=null);var b=a.uuid?a.uuid:a.id,f=vl(this,a);f?(f.label=b,f.friendlyName=a.name):(f=new chrome.cast.Receiver(b,a.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
...
W.prototype.setLaunchParams=W.prototype.le;W.prototype.setConnectedScreenStatus=W.prototype.ke;W.prototype.stopSession=W.prototype.ye;W.prototype.getCastSession=W.prototype.xe;W.prototype.requestSession=W.prototype.requestSession;W.prototype.init=W.prototype.init;W.prototype.dispose=W.prototype.dispose;function xl(a,b,c){yl()?Al(a)&&(Bl(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?Cl(b):(window.__onGCastApiAvailable=function(a,c){a?Cl(b):(Dl("Failed to load cast API: "+c),El(!1),Bl(!1),Bj("yt-remote-cast-available"),Bj("yt-remote-cast-receiver"),Fl(),b(!1))},c?qc("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):Sj())):zl("Cannot initialize because not running Chrome")}
function Fl(){zl("dispose");var a=Gl();a&&a.dispose();Hl=null;q("yt.mdx.remote.cloudview.instance_",null,void 0);Il(!1);mc(Jl);Jl.length=0}
function Kl(){return!!T("yt-remote-cast-installed")}
function Ll(){var a=T("yt-remote-cast-receiver");a?(a=a.friendlyName,a=-1!=a.indexOf("&")?"document"in l?za(a):Ba(a):a):a=null;return a}
function Ml(){zl("clearCurrentReciever");Bj("yt-remote-cast-receiver")}
function Nl(){Kl()?Gl()?Ol()?(zl("Requesting cast selector."),Hl.requestSession()):(zl("Wait for cast API to be ready to request the session."),Jl.push(kc("yt-remote-cast2-api-ready",Nl))):Dl("requestCastSelector: Cast is not initialized."):Dl("requestCastSelector: Cast API is not installed!")}
...
var Hl=null;function yl(){var a;a=0<=lb.search(/\ (CrMo|Chrome|CriOS)\//);return pf||a}
...
return a[tm]}
;function um(){D.call(this);this.g=new bm(this);this.qa=this;this.Z=null}
...
function vm(a,b){var c,d=a.Z;if(d){c=[];for(var e=1;d;d=d.Z)c.push(d),++e}var d=a.qa,e=b,f=e.type||e;if(v(e))e=new Ul(e,d);else if(e instanceof Ul)e.target=e.target||d;else{var h=e,e=new Ul(f,d);kb(e,h)}var h=!0,k;if(c)for(var m=c.length-1;!e.b&&0<=m;m--)k=e.currentTarget=c[m],h=wm(k,f,!0,e)&&h;e.b||(k=e.currentTarget=d,h=wm(k,f,!0,e)&&h,e.b||(h=wm(k,f,!1,e)&&h));if(c)for(m=0;!e.b&&m<c.length;m++)k=e.currentTarget=c[m],h=wm(k,f,!1,e)&&h}
g.A=function(){um.B.A.call(this);if(this.g){var a=this.g,b=0,c;for(c in a.b){for(var d=a.b[c],e=0;e<d.length;e++)++b,am(d[e]);delete a.b[c];a.f--}}this.Z=null};
g.lb=function(a,b,c,d){return cm(this.g,String(a),b,c,d)};
g.tb=function(a,b,c,d){return this.g.remove(String(a),b,c,d)};
function wm(a,b,c,d){b=a.g.b[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var h=b[f];if(h&&!h.Na&&h.gb==c){var k=h.listener,m=h.kb||h.src;h.fb&&em(a.g,h);e=!1!==k.call(m,d)&&e}}return e&&0!=d.zc}
;function xm(a,b){this.f=new qd(a);this.b=b?od:nd}
xm.prototype.stringify=function(a){return pd(this.f,a)};
...
y(ym,um);g=ym.prototype;g.enabled=!1;g.$=null;function zm(a,b){a.b=b;a.$&&a.enabled?(a.stop(),a.start()):a.$&&a.stop()}
g.ne=function(){if(this.enabled){var a=x()-this.j;0<a&&a<.8*this.b?this.$=this.f.setTimeout(this.i,this.b-a):(this.$&&(this.f.clearTimeout(this.$),this.$=null),vm(this,"tick"),this.enabled&&(this.$=this.f.setTimeout(this.i,this.b),this.j=x()))}};
...
y(Bm,D);g=Bm.prototype;g.Oa=!1;g.ab=0;g.za=null;g.dd=function(a){this.b=arguments;this.za||this.ab?this.Oa=!0:Cm(this)};
g.stop=function(){this.za&&(l.clearTimeout(this.za),this.za=null,this.Oa=!1,this.b=[])};
g.pause=function(){this.ab++};
g.resume=function(){this.ab--;this.ab||!this.Oa||this.za||(this.Oa=!1,Cm(this))};
g.A=function(){Bm.B.A.call(this);this.stop()};
g.Pd=function(){this.za=null;this.Oa&&!this.ab&&(this.Oa=!1,Cm(this))};
function Cm(a){a.za=Am(a.f,a.g);a.i.apply(null,a.b)}
;function Dm(a){D.call(this);this.f=a;this.b={}}
y(Dm,D);var Em=[];Dm.prototype.lb=function(a,b,c,d){u(b)||(b&&(Em[0]=b.toString()),b=Em);for(var e=0;e<b.length;e++){var f=jm(a,b[e],c||this.handleEvent,d||!1,this.f||this);if(!f)break;this.b[f.key]=f}return this};
Dm.prototype.tb=function(a,b,c,d,e){if(u(b))for(var f=0;f<b.length;f++)this.tb(a,b[f],c,d,e);else c=c||this.handleEvent,e=e||this.f||this,c=km(c),d=!!d,b=a&&a[Yl]?fm(a.g,String(b),c,d,e):a?(a=lm(a))?fm(a,b,c,d,e):null:null,b&&(qm(b),delete this.b[b.key]);return this};
function Fm(a){Xa(a.b,function(a,c){this.b.hasOwnProperty(c)&&qm(a)},a);
a.b={}}
...
g=Mm.prototype;g.Aa=null;g.fa=!1;g.Qa=null;g.Sb=null;g.bb=null;g.Pa=null;g.ra=null;g.ua=null;g.Fa=null;g.J=null;g.eb=0;g.ga=null;g.wb=null;g.Ba=null;g.Za=-1;g.Ac=!0;g.wa=!1;g.Jb=0;g.qb=null;var Nm={},Om={};g=Mm.prototype;g.setTimeout=function(a){this.j=a};
function Pm(a,b,c){a.Pa=1;a.ra=Vg(b.clone());a.Fa=c;a.o=!0;Qm(a,null)}
function Rm(a,b,c,d,e){a.Pa=1;a.ra=Vg(b.clone());a.Fa=null;a.o=c;e&&(a.Ac=!1);Qm(a,d)}
function Qm(a,b){a.bb=x();Sm(a);a.ua=a.ra.clone();Tg(a.ua,"t",a.l);a.eb=0;a.J=a.b.Cb(a.b.cb()?b:null);0<a.Jb&&(a.qb=new Bm(w(a.Fc,a,a.J),a.Jb));a.i.lb(a.J,"readystatechange",a.$d);var c=a.Aa?hb(a.Aa):{};a.Fa?(a.wb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.J.send(a.ua,a.wb,a.Fa,c)):(a.wb="GET",a.Ac&&!$c&&(c.Connection="close"),a.J.send(a.ua,a.wb,null,c));a.b.ea(1)}
g.$d=function(a){a=a.target;var b=this.qb;b&&3==Tm(a)?b.dd():this.Fc(a)};
g.Fc=function(a){try{if(a==this.J)a:{var b=Tm(this.J),c=this.J.j,d=this.J.getStatus();if(K&&!kd(10)||$c&&!jd("420+")){if(4>b)break a}else if(3>b||3==b&&!Xc&&!Um(this.J))break a;this.wa||4!=b||7==c||(8==c||0>=d?this.b.ea(3):this.b.ea(2));Vm(this);var e=this.J.getStatus();this.Za=e;var f=Um(this.J);(this.fa=200==e)?(4==b&&Wm(this),this.o?(Xm(this,b,f),Xc&&this.fa&&3==b&&(this.i.lb(this.f,"tick",this.Yd),this.f.start())):Ym(this,f),this.fa&&!this.wa&&(4==b?this.b.nb(this):(this.fa=!1,Sm(this)))):(this.Ba=
400==e&&0<f.indexOf("Unknown SID")?3:0,X(),Wm(this),Zm(this))}}catch(h){this.J&&Um(this.J)}finally{}};
function Xm(a,b,c){for(var d=!0;!a.wa&&a.eb<c.length;){var e=$m(a,c);if(e==Om){4==b&&(a.Ba=4,X(),d=!1);break}else if(e==Nm){a.Ba=4;X();d=!1;break}else Ym(a,e)}4==b&&0==c.length&&(a.Ba=1,X(),d=!1);a.fa=a.fa&&d;d||(Wm(a),Zm(a))}
g.Yd=function(){var a=Tm(this.J),b=Um(this.J);this.eb<b.length&&(Vm(this),Xm(this,a,b),this.fa&&4!=a&&Sm(this))};
function $m(a,b){var c=a.eb,d=b.indexOf("\n",c);if(-1==d)return Om;c=Number(b.substring(c,d));if(isNaN(c))return Nm;d+=1;if(d+c>b.length)return Om;var e=b.substr(d,c);a.eb=d+c;return e}
function an(a,b){a.bb=x();Sm(a);var c=b?window.location.hostname:"";a.ua=a.ra.clone();N(a.ua,"DOMAIN",c);N(a.ua,"t",a.l);try{a.ga=new ActiveXObject("htmlfile")}catch(n){Wm(a);a.Ba=7;X();Zm(a);return}var d="<html><body>";if(b){for(var e="",f=0;f<c.length;f++){var h=c.charAt(f);if("<"==h)e+="\\x3c";else if(">"==h)e+="\\x3e";else{if(h in Da)h=Da[h];else if(h in Ca)h=Da[h]=Ca[h];else{var k,m=h.charCodeAt(0);if(31<m&&127>m)k=h;else{if(256>m){if(k="\\x",16>m||256<m)k+="0"}else k="\\u",4096>m&&(k+="0");
...
g.Rd=function(a){this.wa||(Wm(this),this.fa=a,this.b.nb(this),this.b.ea(4))};
g.cancel=function(){this.wa=!0;Wm(this)};
function Sm(a){a.Sb=x()+a.j;cn(a,a.j)}
function cn(a,b){if(null!=a.Qa)throw Error("WatchDog timer not null");a.Qa=bn(w(a.Vd,a),b)}
function Vm(a){a.Qa&&(l.clearTimeout(a.Qa),a.Qa=null)}
g.Vd=function(){this.Qa=null;var a=x();0<=a-this.Sb?(2!=this.Pa&&this.b.ea(3),Wm(this),this.Ba=2,X(),Zm(this)):cn(this,this.Sb-a)};
function Zm(a){a.b.ic()||a.wa||a.b.nb(a)}
function Wm(a){Vm(a);E(a.qb);a.qb=null;a.f.stop();Fm(a.i);if(a.J){var b=a.J;a.J=null;dn(b);b.dispose()}a.ga&&(a.ga=null)}
...
g=hn.prototype;g.Hb=null;g.Y=null;g.rb=!1;g.Dc=null;g.hb=null;g.Mb=null;g.Ib=null;g.aa=null;g.pa=-1;g.Ya=null;g.Ua=null;g.connect=function(a){this.Ib=a;a=jn(this.b,null,this.Ib);X();this.Dc=x();var b=this.b.u;null!=b?(this.Ya=b[0],(this.Ua=b[1])?(this.aa=1,kn(this)):(this.aa=2,ln(this))):(Tg(a,"MODE","init"),this.Y=new Mm(this,0,void 0,void 0,void 0),this.Y.Aa=this.Hb,Rm(this.Y,a,!1,null,!0),this.aa=0)};
function kn(a){var b=jn(a.b,a.Ua,"/mail/images/cleardot.gif");Vg(b);en(b.toString(),5E3,w(a.$c,a),3,2E3);a.ea(1)}
g.$c=function(a){if(a)this.aa=2,ln(this);else{X();var b=this.b;b.da=b.sa.pa;mn(b,9)}a&&this.ea(2)};
function ln(a){var b=a.b.N;if(null!=b)X(),b?(X(),nn(a.b,a,!1)):(X(),nn(a.b,a,!0));else if(a.Y=new Mm(a,0,void 0,void 0,void 0),a.Y.Aa=a.Hb,b=a.b,b=jn(b,b.cb()?a.Ya:null,a.Ib),X(),!K||kd(10))Tg(b,"TYPE","xmlhttp"),Rm(a.Y,b,!1,a.Ya,!1);else{Tg(b,"TYPE","html");var c=a.Y;a=!!a.Ya;c.Pa=3;c.ra=Vg(b.clone());an(c,a)}}
g.Cb=function(a){return this.b.Cb(a)};
g.ic=function(){return!1};
g.pc=function(a,b){this.pa=a.Za;if(0==this.aa)if(b){try{var c=this.f.parse(b)}catch(d){c=this.b;c.da=this.pa;mn(c,2);return}this.Ya=c[0];this.Ua=c[1]}else c=this.b,c.da=this.pa,mn(c,2);else if(2==this.aa)if(this.rb)X(),this.Mb=x();else if("11111"==b){if(X(),this.rb=!0,this.hb=x(),c=this.hb-this.Dc,!K||kd(10)||500>c)this.pa=200,this.Y.cancel(),X(),nn(this.b,this,!0)}else X(),this.hb=this.Mb=x(),this.rb=!1};
g.nb=function(){this.pa=this.Y.Za;if(this.Y.fa)0==this.aa?this.Ua?(this.aa=1,kn(this)):(this.aa=2,ln(this)):2==this.aa&&((!K||kd(10)?!this.rb:200>this.Mb-this.hb)?(X(),nn(this.b,this,!1)):(X(),nn(this.b,this,!0)));else{0==this.aa?X():2==this.aa&&X();var a=this.b;a.da=this.pa;mn(a,2)}};
g.cb=function(){return this.b.cb()};
g.isActive=function(){return this.b.isActive()};
g.ea=function(a){this.b.ea(a)};function on(a){um.call(this);this.headers=new Ic;this.L=a||null;this.f=!1;this.K=this.b=null;this.ka=this.D="";this.j=0;this.o="";this.i=this.V=this.u=this.U=!1;this.l=0;this.F=null;this.la="";this.H=this.ia=!1}
y(on,um);var pn=/^https?$/i,qn=["POST","PUT"];g=on.prototype;
g.send=function(a,b,c,d){if(this.b)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);b=b?b.toUpperCase():"GET";this.D=a;this.o="";this.j=0;this.ka=b;this.U=!1;this.f=!0;this.b=this.L?Lm(this.L):Lm(Jm);this.K=this.L?Hm(this.L):Hm(Jm);this.b.onreadystatechange=w(this.oc,this);try{Rl(rn(this,"Opening Xhr")),this.V=!0,this.b.open(b,String(a),!0),this.V=!1}catch(f){Rl(rn(this,"Error opening Xhr: "+f.message));sn(this,f);return}a=c||"";var e=this.headers.clone();
d&&Qc(d,function(a,b){e.set(b,a)});
d=Ma(e.ja(),tn);c=l.FormData&&a instanceof l.FormData;!A(qn,b)||d||c||e.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(a,b){this.b.setRequestHeader(b,a)},this);
...
function vn(a){return K&&jd(9)&&ea(a.timeout)&&p(a.ontimeout)}
...
function wn(a){a.U||(a.U=!0,vm(a,"complete"),vm(a,"error"))}
...
g.oc=function(){this.isDisposed()||(this.V||this.u||this.i?yn(this):this.Hd())};
...
;function zn(a,b,c){this.l=a||null;this.b=1;this.f=[];this.i=[];this.j=new xm(null,!0);this.u=b||null;this.N=null!=c?c:null}
function An(a,b){this.b=a;this.map=b;this.context=null}
g=zn.prototype;g.Wa=null;g.T=null;g.G=null;g.Gb=null;g.ib=null;g.Zb=null;g.jb=null;g.$a=0;g.sd=0;g.M=null;g.ta=null;g.oa=null;g.ya=null;g.sa=null;g.vb=null;g.La=-1;g.jc=-1;g.da=-1;g.Xa=0;g.Ka=0;g.xa=8;var Bn=new um;function Cn(a){Ul.call(this,"statevent",a)}
y(Cn,Ul);function Dn(a,b){Ul.call(this,"timingevent",a);this.size=b}
y(Dn,Ul);function En(a){Ul.call(this,"serverreachability",a)}
y(En,Ul);g=zn.prototype;g.connect=function(a,b,c,d,e){X();this.Gb=b;this.Wa=c||{};d&&p(e)&&(this.Wa.OSID=d,this.Wa.OAID=e);this.sa=new hn(this);this.sa.Hb=null;this.sa.f=this.j;this.sa.connect(a)};
function Fn(a){Gn(a);if(3==a.b){var b=a.$a++,c=a.ib.clone();N(c,"SID",a.g);N(c,"RID",b);N(c,"TYPE","terminate");Hn(a,c);b=new Mm(a,0,a.g,b,void 0);b.Pa=2;b.ra=Vg(c.clone());(new Image).src=b.ra;b.bb=x();Sm(b)}In(a)}
function Gn(a){if(a.sa){var b=a.sa;b.Y&&(b.Y.cancel(),b.Y=null);b.pa=-1;a.sa=null}a.G&&(a.G.cancel(),a.G=null);a.oa&&(l.clearTimeout(a.oa),a.oa=null);Jn(a);a.T&&(a.T.cancel(),a.T=null);a.ta&&(l.clearTimeout(a.ta),a.ta=null)}
...
function Ln(a){a.T||a.ta||(a.ta=bn(w(a.uc,a),0),a.Xa=0)}
g.uc=function(a){this.ta=null;Mn(this,a)};
function Mn(a,b){if(1==a.b){if(!b){a.$a=Math.floor(1E5*Math.random());var c=a.$a++,d=new Mm(a,0,"",c,void 0);d.Aa=null;var e=Nn(a),f=a.ib.clone();N(f,"RID",c);a.l&&N(f,"CVER",a.l);Hn(a,f);Pm(d,f,e);a.T=d;a.b=2}}else 3==a.b&&(b?On(a,b):0!=a.f.length&&(a.T||On(a)))}
function On(a,b){var c,d;b?6<a.xa?(a.f=a.i.concat(a.f),a.i.length=0,c=a.$a-1,d=Nn(a)):(c=b.u,d=b.Fa):(c=a.$a++,d=Nn(a));var e=a.ib.clone();N(e,"SID",a.g);N(e,"RID",c);N(e,"AID",a.La);Hn(a,e);c=new Mm(a,0,a.g,c,a.Xa+1);c.Aa=null;c.setTimeout(Math.round(1E4)+Math.round(1E4*Math.random()));a.T=c;Pm(c,e,d)}
function Hn(a,b){if(a.M){var c=a.M.fc(a);c&&Xa(c,function(a,c){N(b,c,a)})}}
function Nn(a){var b=Math.min(a.f.length,1E3),c=["count="+b],d;6<a.xa&&0<b?(d=a.f[0].b,c.push("ofs="+d)):d=0;for(var e=0;e<b;e++){var f=a.f[e].b,h=a.f[e].map,f=6>=a.xa?e:f-d;try{Qc(h,function(a,b){c.push("req"+f+"_"+b+"="+encodeURIComponent(a))})}catch(k){c.push("req"+f+"_type="+encodeURIComponent("_badmap"))}}a.i=a.i.concat(a.f.splice(0,b));
return c.join("&")}
function Pn(a){a.G||a.oa||(a.o=1,a.oa=bn(w(a.tc,a),0),a.Ka=0)}
function Qn(a){if(a.G||a.oa||3<=a.Ka)return!1;a.o++;a.oa=bn(w(a.tc,a),Rn(a,a.Ka));a.Ka++;return!0}
g.tc=function(){this.oa=null;this.G=new Mm(this,0,this.g,"rpc",this.o);this.G.Aa=null;this.G.Jb=0;var a=this.Zb.clone();N(a,"RID","rpc");N(a,"SID",this.g);N(a,"CI",this.vb?"0":"1");N(a,"AID",this.La);Hn(this,a);if(!K||kd(10))N(a,"TYPE","xmlhttp"),Rm(this.G,a,!0,this.jb,!1);else{N(a,"TYPE","html");var b=this.G,c=!!this.jb;b.Pa=3;b.ra=Vg(a.clone());an(b,c)}};
function nn(a,b,c){a.vb=c;a.da=b.pa;a.cd(1,0);a.ib=jn(a,null,a.Gb);Ln(a)}
g.pc=function(a,b){if(0!=this.b&&(this.G==a||this.T==a))if(this.da=a.Za,this.T==a&&3==this.b)if(7<this.xa){var c;try{c=this.j.parse(b)}catch(f){c=null}if(u(c)&&3==c.length)if(0==c[0])a:{if(!this.oa){if(this.G)if(this.G.bb+3E3<this.T.bb)Jn(this),this.G.cancel(),this.G=null;else break a;Qn(this);X()}}else this.jc=c[1],0<this.jc-this.La&&37500>c[2]&&this.vb&&0==this.Ka&&!this.ya&&(this.ya=bn(w(this.td,this),6E3));else mn(this,11)}else b!=Me.Ee.b&&mn(this,11);else if(this.G==a&&Jn(this),!/^[\s\xa0]*$/.test(b)){c=
this.j.parse(b);u(c);for(var d=0;d<c.length;d++){var e=c[d];this.La=e[0];e=e[1];2==this.b?"c"==e[0]?(this.g=e[1],this.jb=e[2],e=e[3],null!=e?this.xa=e:this.xa=6,this.b=3,this.M&&this.M.dc(this),this.Zb=jn(this,this.cb()?this.jb:null,this.Gb),Pn(this)):"stop"==e[0]&&mn(this,7):3==this.b&&("stop"==e[0]?mn(this,7):"noop"!=e[0]&&this.M&&this.M.cc(this,e),this.Ka=0)}}};
...
g.nb=function(a){var b;if(this.G==a)Jn(this),this.G=null,b=2;else if(this.T==a)this.T=null,b=1;else return;this.da=a.Za;if(0!=this.b)if(a.fa)1==b?(x(),vm(Bn,new Dn(Bn,a.Fa?a.Fa.length:0)),Ln(this),this.i.length=0):Pn(this);else{var c=a.Ba,d;if(!(d=3==c||7==c||0==c&&0<this.da)){if(d=1==b)this.T||this.ta||1==this.b||2<=this.Xa?d=!1:(this.ta=bn(w(this.uc,this,a),Rn(this,this.Xa)),this.Xa++,d=!0);d=!(d||2==b&&Qn(this))}if(d)switch(c){case 1:mn(this,5);break;case 4:mn(this,10);break;case 3:mn(this,6);
...
function mn(a,b){if(2==b||9==b){var c=null;a.M&&(c=null);var d=w(a.me,a);c||(c=new Fg("//www.google.com/images/cleardot.gif"),Vg(c));fn(c.toString(),1E4,d)}else X();Sn(a,b)}
g.me=function(a){a?X():(X(),Sn(this,8))};
function Sn(a,b){a.b=0;a.M&&a.M.bc(a,b);In(a);Gn(a)}
function In(a){a.b=0;a.da=-1;if(a.M)if(0==a.i.length&&0==a.f.length)a.M.Ab(a);else{var b=Sa(a.i),c=Sa(a.f);a.i.length=0;a.f.length=0;a.M.Ab(a,b,c)}}
function jn(a,b,c){var d=Wg(c);if(""!=d.f)b&&Hg(d,b+"."+d.f),Ig(d,d.l);else var e=window.location,d=Xg(e.protocol,b?b+"."+e.hostname:e.hostname,e.port,c);a.Wa&&Xa(a.Wa,function(a,b){N(d,b,a)});
...
;function Wn(a,b){this.F=a;this.o=b;this.g=new F;this.f=new Un(this.qe,this);this.b=null;this.D=!1;this.j=null;this.N="";this.u=this.i=0;this.l=[]}
...
g.dispose=function(){this.D||(this.D=!0,this.g.clear(),Xn(this),E(this.g))};
g.isDisposed=function(){return this.D};
function Yn(a){return{firstTestResults:[""],secondTestResults:!a.b.vb,sessionId:a.b.g,arrayId:a.b.La}}
...
g.sendMessage=function(a,b){var c={_sc:a};b&&kb(c,b);this.f.enabled||2==(this.b?this.b.b:0)?this.l.push(c):Zn(this)&&Kn(this.b,c)};
...
g.cc=function(a,b){"S"==b[0]?this.N=b[1]:"gracefulReconnect"==b[0]?(Vn(this.f),this.f.start(),Fn(this.b)):this.w("handlerMessage",new Sl(b[0],b[1]))};
function Zn(a){return!!a.b&&3==a.b.b}
function $n(a,b){(a.o.loungeIdToken=b)||a.f.stop()}
g.qe=function(){this.f.stop();var a=this.b,b=0;a.G&&b++;a.T&&b++;0!=b?this.f.start():this.connect(this.j,this.i)};function ao(a){this.index=-1;this.videoId=this.f="";this.volume=this.b=-1;this.o=!1;this.audioTrackId=null;this.j=this.g=0;this.i=null;this.reset(a)}
...
function eo(a){var b={};b.index=a.index;b.listId=a.f;b.videoId=a.videoId;b.playerState=a.b;b.volume=a.volume;b.muted=a.o;b.audioTrackId=a.audioTrackId;b.trackData=ib(a.i);b.playerTime=a.g;b.playerTimeAt=a.j;return b}
ao.prototype.clone=function(){return new ao(eo(this))};function Y(a,b,c){U.call(this);this.i=NaN;this.U=!1;this.H=this.F=this.K=this.L=NaN;this.V=[];this.u=this.D=this.g=this.C=this.b=null;this.Sa=a;this.V.push(M(window,"beforeunload",w(this.jd,this)));this.f=[];this.C=new ao;this.ia=b.id;this.b=fo(this,c);this.b.subscribe("handlerOpened",this.xd,this);this.b.subscribe("handlerClosed",this.ud,this);this.b.subscribe("handlerError",this.vd,this);this.b.subscribe("handlerMessage",this.wd,this);$n(this.b,b.token);this.subscribe("remoteQueueChange",function(){var a=
this.C.videoId;Gk()&&S("yt-remote-session-video-id",a)},this)}
y(Y,U);g=Y.prototype;g.connect=function(a,b){if(b){var c=b.listId,d=b.videoId,e=b.index,f=b.currentTime||0;5>=f&&(f=0);var h={videoId:d,currentTime:f};c&&(h.listId=c);p(e)&&(h.currentIndex=e);c&&(this.C.f=c);this.C.videoId=d;this.C.index=e||0;this.C.state=3;c=this.C;c.g=f;c.j=x();this.u="UNSUPPORTED";go("Connecting with setPlaylist and params: "+L(h));this.b.connect({method:"setPlaylist",params:L(h)},a,Kk())}else go("Connecting without params"),this.b.connect({},a,Kk());ho(this)};
g.dispose=function(){this.isDisposed()||(this.w("beforeDispose"),io(this,3));Y.B.dispose.call(this)};
g.A=function(){jo(this);ko(this);lo(this);I(this.F);this.F=NaN;I(this.H);this.H=NaN;this.g=null;He(this.V);this.V.length=0;this.b.dispose();Y.B.A.call(this);this.u=this.D=this.f=this.C=this.b=null};
function go(a){ck("conn",a)}
g.jd=function(){this.j(2)};
function fo(a,b){return new Wn(ok(a.Sa,"/bc",void 0,!1),b)}
...
function lo(a){I(a.L);a.L=NaN}
function mo(a){ko(a);a.K=H(w(function(){no(this,"getNowPlaying")},a),2E4)}
function ko(a){I(a.K);a.K=NaN}
g.xd=function(){go("Channel opened");this.U&&(this.U=!1,lo(this),this.L=H(w(function(){go("Timing out waiting for a screen.");this.j(1)},this),15E3));
Ok(Yn(this.b),this.ia)};
g.ud=function(){go("Channel closed");isNaN(this.i)?Pk(!0):Pk();this.dispose()};
g.vd=function(a){Pk();isNaN(this.l())?(go("Channel error: "+a+" without reconnection"),this.dispose()):(this.U=!0,go("Channel error: "+a+" with reconnection in "+this.l()+" ms"),io(this,2))};
function oo(a,b){b&&(jo(a),lo(a));b==(Zn(a.b)&&isNaN(a.i))?b&&(io(a,1),no(a,"getSubtitlesTrack")):b?(a.Z()&&a.C.reset(),io(a,1),no(a,"getNowPlaying"),po(a)):a.j(1)}
function qo(a,b){var c=b.params.videoId;delete b.params.videoId;c==a.C.videoId&&(fb(b.params)?a.C.i=null:a.C.i=b.params,a.w("remotePlayerChange"))}
...
g.wd=function(a){a.params?go("Received: action="+a.action+", params="+L(a.params)):go("Received: action="+a.action+" {}");switch(a.action){case "loungeStatus":a=nd(a.params.devices);this.f=Ja(a,function(a){return new Bk(a)});
a=!!Ma(this.f,function(a){return"LOUNGE_SCREEN"==a.type});
oo(this,a);break;case "loungeScreenConnected":oo(this,!0);break;case "loungeScreenDisconnected":Qa(this.f,function(a){return"LOUNGE_SCREEN"==a.type});
oo(this,!1);break;case "remoteConnected":var b=new Bk(nd(a.params.device));Ma(this.f,function(a){return a.equals(b)})||Oa(this.f,b);
break;case "remoteDisconnected":b=new Bk(nd(a.params.device));Qa(this.f,function(a){return a.equals(b)});
break;case "gracefulDisconnect":break;case "playlistModified":ro(this,a);break;case "nowPlaying":so(this,a);break;case "onStateChange":to(this,a);break;case "onVolumeChanged":uo(this,a);break;case "onSubtitlesTrackChanged":qo(this,a);break;case "nowAutoplaying":this.D=a.params.videoId;break;case "autoplayDismissed":break;case "autoplayUpNext":this.D=a.params.videoId;break;case "onAutoplayModeChanged":this.u=a.params.autoplayMode;break;default:go("Unrecognized action: "+a.action)}};
g.ce=function(){if(this.g){var a=this.g;this.g=null;this.C.videoId!=a&&no(this,"getNowPlaying")}};
Y.prototype.subscribe=Y.prototype.subscribe;Y.prototype.unsubscribeByKey=Y.prototype.ha;Y.prototype.Ha=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.l())?Zn(this.b)&&isNaN(this.i)&&(a=1):a=2);return a};
Y.prototype.getProxyState=Y.prototype.Ha;Y.prototype.j=function(a){go("Disconnecting with "+a);jo(this);this.w("beforeDisconnect",a);1==a&&Pk();Xn(this.b,a);this.dispose()};
Y.prototype.disconnect=Y.prototype.j;Y.prototype.qa=function(){var a=this.C;if(this.g){var b=a=this.C.clone(),c=this.g,d=a.index,e=b.videoId;b.videoId=c;b.index=d;c!=e&&bo(b)}return eo(a)};
Y.prototype.getPlayerContextData=Y.prototype.qa;Y.prototype.Ra=function(a){var b=new ao(a);b.videoId&&b.videoId!=this.C.videoId&&(this.g=b.videoId,I(this.F),this.F=H(w(this.ce,this),5E3));var c=[];this.C.f==b.f&&this.C.videoId==b.videoId&&this.C.index==b.index||c.push("remoteQueueChange");this.C.b==b.b&&this.C.volume==b.volume&&this.C.o==b.o&&co(this.C)==co(b)&&L(this.C.i)==L(b.i)||c.push("remotePlayerChange");this.C.reset(a);z(c,function(a){this.w(a)},this)};
...
Y.prototype.getReconnectTimeout=Y.prototype.l;Y.prototype.ka=function(){return this.u||"UNSUPPORTED"};
...
Y.prototype.reconnect=Y.prototype.Ta;function po(a){I(a.H);a.H=H(w(a.j,a,1),864E5)}
function no(a,b,c){c?go("Sending: action="+b+", params="+L(c)):go("Sending: action="+b);a.b.sendMessage(b,c)}
Y.prototype.Ia=function(a,b){no(this,a,b);po(this)};
Y.prototype.sendMessage=Y.prototype.Ia;function vo(a){vk.call(this,"ScreenServiceProxy");this.R=a;this.b=[];this.b.push(this.R.$_s("screenChange",w(this.ue,this)));this.b.push(this.R.$_s("onlineScreenChange",w(this.Dd,this)))}
y(vo,vk);g=vo.prototype;g.W=function(a){return this.R.$_gs(a)};
...
g.A=function(){for(var a=0,b=this.b.length;a<b;++a)this.R.$_ubk(this.b[a]);this.b.length=0;this.R=null;vo.B.A.call(this)};
g.ue=function(){this.w("screenChange")};
g.Dd=function(){this.w("onlineScreenChange")};
V.prototype.$_st=V.prototype.start;V.prototype.$_gspc=V.prototype.ve;V.prototype.$_gsppc=V.prototype.Hc;V.prototype.$_c=V.prototype.contains;V.prototype.$_g=V.prototype.get;V.prototype.$_a=V.prototype.xb;V.prototype.$_un=V.prototype.ub;V.prototype.$_r=V.prototype.remove;V.prototype.$_gs=V.prototype.W;V.prototype.$_gos=V.prototype.Gc;V.prototype.$_s=V.prototype.subscribe;V.prototype.$_ubk=V.prototype.ha;function wo(){var a={device:"Desktop",app:"youtube-desktop"};zj&&yj();Dk();xo||(xo=new nk,Qk()&&(xo.b="/api/loungedev"));yo||(yo=r("yt.mdx.remote.deferredProxies_")||[],q("yt.mdx.remote.deferredProxies_",yo,void 0));zo();var b=Ao();if(!b){var c=new V(xo);q("yt.mdx.remote.screenService_",c,void 0);b=Ao();xl(c,function(a){a?Bo()&&Ql(Bo(),"YouTube TV"):c.subscribe("onlineScreenChange",function(){J("yt-remote-receiver-availability-change")})},!(!a||!a.loadCastApiSetupScript))}if(a&&!r("yt.mdx.remote.initialized_")){q("yt.mdx.remote.initialized_",
!0,void 0);
Co("Initializing: "+L(a));Do.push(kc("yt-remote-cast2-availability-change",function(){J("yt-remote-receiver-availability-change")}));
Do.push(kc("yt-remote-cast2-receiver-selected",function(){Eo(null);J("yt-remote-auto-connect","cast-selector-receiver")}));
Do.push(kc("yt-remote-cast2-session-change",Fo));Do.push(kc("yt-remote-connection-change",function(a){a?Ql(Bo(),"YouTube TV"):Go()||(Ql(null,null),Ml())}));
var d=Ho();a.isAuto&&(d.id+="#dial");d.name=a.device;d.app=a.app;Co(" -- with channel params: "+L(d));Io(d);b.start();Bo()||Jo()}}
function Ko(){mc(Do);Do.length=0;E(Lo);Lo=null;yo&&(z(yo,function(a){a(null)}),yo.length=0,yo=null,q("yt.mdx.remote.deferredProxies_",null,void 0));
xo=null}
function Mo(){if(Kl()){var a=[];if(T("yt-remote-cast-available")||r("yt.mdx.remote.cloudview.castButtonShown_")||No())a.push({key:"cast-selector-receiver",name:Oo()}),q("yt.mdx.remote.cloudview.castButtonShown_",!0,void 0);return a}return r("yt.mdx.remote.cloudview.initializing_")?[]:Po()}
function Po(){var a;a=Ao().R.$_gos();var b=Qo();b&&No()&&(tk(a,b)||a.push(b));return sk(a)}
function Ro(){if(Kl()){var a=Ll();return a?{key:"cast-selector-receiver",name:a}:null}return So()}
function So(){var a=Po(),b=Qo();b||(b=Go());return Ma(a,function(a){return b&&gk(b,a.key)?!0:!1})}
function Oo(){if(Kl())return Ll();var a=Qo();return a?a.name:null}
function Qo(){var a=Bo();if(!a)return null;var b=Ao().W();return uk(b,a)}
function Fo(a){Co("remote.onCastSessionChange_: "+kk(a));if(a){var b=Qo();b&&b.id==a.id?Ql(b.id,"YouTube TV"):(b&&To(),Uo(a,1))}else To()}
function Vo(a,b){Co("Connecting to: "+L(a));if("cast-selector-receiver"==a.key)Eo(b||null),Pl(b||null);else{To();Eo(b||null);var c=Ao().W();(c=uk(c,a.key))?Uo(c,1):H(function(){Wo(null)},0)}}
function To(){Ol()?Gl().stopSession():Dl("stopSession called before API ready.");var a=No();a?a.disconnect(1):(nc("yt-remote-before-disconnect",1),nc("yt-remote-connection-change",!1));Wo(null)}
...
function Go(){var a=Gk();if(!a)return null;var b=Ao().W();return uk(b,a)}
function Uo(a,b){Bo();Xo(a.id);var c=new Y(xo,a,Ho());c.connect(b,r("yt.mdx.remote.connectData_"));c.subscribe("beforeDisconnect",function(a){nc("yt-remote-before-disconnect",a)});
...
var xo=null,yo=null,Lo=null;function zo(){var a=Ho();if(fb(a)){var a=Fk(),b=T("yt-remote-session-name")||"",c=T("yt-remote-session-app")||"",a={device:"REMOTE_CONTROL",id:a,name:b,app:c,"mdx-version":3};q("yt.mdx.remote.channelParams_",a,void 0)}}
...
function hp(a){Li()?(Q(yi,new si(a.externalChannelId,a.rd?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Cd({event:"subscribe",source:a.source}))&&hh(a)):ip(a)}
function ip(a){Ki(function(b){b.subscription_ajax&&hp(a)},null)}
function jp(a){a=fp(a);Q(Di,new ui(a.externalChannelId,a.subscriptionId,null));(a="/gen_204?"+Cd({event:"unsubscribe",source:a.source}))&&hh(a)}
...
(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());up(this,a)};
...
g.ie=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:x()/1E3};this.b.getProgressState&&(a.progressState=this.b.getProgressState());up(this,a)};
...
wp.prototype.A=function(){this.f=this.b=null;wp.B.A.call(this)};function xp(a,b,c){D.call(this);this.b=a;this.g=c;this.i=M(window,"message",w(this.j,this));this.f=new wp(this,a,b);Ub(this,ma(E,this.f))}
...
xp.prototype.A=function(){He(this.i);this.b=null;xp.B.A.call(this)};var yp=!1;function zp(a){if(a=a.match(/[\d]+/g))a.length=3}
...
new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6");yp=!0;return}catch(c){}try{b=new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),yp=!0,zp(b.GetVariable("$version"))}catch(c){}})();function Ap(a){return(a=a.exec(lb))?a[1]:""}
(function(){if(lf)return Ap(/Firefox\/([0-9.]+)/);if(K||Yc||Xc)return hd;if(pf)return Ap(/Chrome\/([0-9.]+)/);if(qf&&!(Wc()||B("iPad")||B("iPod")))return Ap(/Version\/([0-9.]+)/);if(mf||nf){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(lb);if(a)return a[1]+"."+a[2]}else if(of)return(a=Ap(/Android\s+([0-9.]+)/))?a:Ap(/Version\/([0-9.]+)/);return""})();function Bp(){var a=Cp;return new ag(function(b,c){a.ba=function(a){Jd(a)?b(a):c(a)};
a.onError=c;a.Da=c;Od("//googleads.g.doubleclick.net/pagead/id",a)})}
;function Dp(a,b){this.f=a;this.b=b}
Dp.prototype.then=function(a,b,c){try{if(p(this.f))return a?fg(a.call(c,this.f)):fg(this.f);if(p(this.b)){if(!b)return gg(this.b);var d=b.call(c,this.b);return!p(d)&&this.b instanceof ig?gg(this.b):fg(d)}throw Error("Invalid Result_ state");}catch(e){return gg(e)}};
$f(Dp);var Cp={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ep=null;function Fp(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))return Gp(""),Ep=new Dp(""),"";a=JSON.parse(a.substr(4)).id;Gp(a);Ep=new Dp(a);Hp(18E5,2);return a}
function Ip(a){var b=Error("Unable to load /pagead/id");Gp("");Ep=new Dp(void 0,b);0<a&&Hp(12E4,a-1);throw b;}
function Hp(a,b){H(function(){var a=w(Ip,l,b),a=Bp().then(Fp,a);hg(a,null,t,void 0)},a)}
function Gp(a){q("yt.www.ads.biscotti.lastId_",a,void 0)}
;function Jp(){}
;function Kp(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&(c=c.data.follow_on_url)&&hh(c)}}
;function Lp(a){O.call(this,1,arguments);this.zb=a}
y(Lp,O);function Mp(a,b){O.call(this,2,arguments);this.f=a;this.b=b}
y(Mp,O);function Np(a,b,c,d){O.call(this,1,arguments);this.b=b;this.f=c||null;this.itemId=d||null}
y(Np,O);function Op(a,b){O.call(this,1,arguments);this.f=a;this.b=b||null}
y(Op,O);function Pp(a){O.call(this,1,arguments)}
y(Pp,O);var Qp=new P("ypc-core-load",Lp),Rp=new P("ypc-guide-sync-success",Mp),Sp=new P("ypc-purchase-success",Np),Tp=new P("ypc-subscription-cancel",Pp),Up=new P("ypc-subscription-cancel-success",Op),Vp=new P("ypc-init-subscription",Pp);var Wp=!1,Xp=[],Yp=[];function Zp(a){a.b?Wp?Q(Ci,a):Q(Qp,new Lp(function(){Q(Vp,new Pp(a.b))})):$p(a.f,a.i,a.g,a.source)}
function aq(a){a.b?Wp?Q(Hi,a):Q(Qp,new Lp(function(){Q(Tp,new Pp(a.b))})):bq(a.f,a.subscriptionId,a.i,a.g,a.source)}
function cq(a){dq(Sa(a.b))}
function eq(a){fq(Sa(a.b))}
function gq(a){hq(a.b,a.isEnabled,null)}
function iq(a,b,c,d){hq(a,b,c,d)}
function jq(a){var b=a.itemId,c=a.b.subscriptionId;b&&c&&Q(Bi,new ti(b,c,a.b.channelInfo))}
function kq(a){var b=a.b;Xa(a.f,function(a,d){Q(Bi,new ti(d,a,b[d]))})}
function lq(a){Q(Gi,new qi(a.f.itemId));a.b&&a.b.length&&(mq(a.b,Gi),mq(a.b,Ii))}
function $p(a,b,c,d){var e=new qi(a);Q(zi,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=G("PLAYBACK_ID"))&&(c.plid=d);(d=G("EVENT_ID"))&&(c.ei=d);b&&nq(b,c);Od("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Rb:f,S:c,ba:function(b,c){var d=c.response;Q(Bi,new ti(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&J("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Kp(d.actions)},
Nb:function(){Q(Ai,e)}})}
function bq(a,b,c,d,e){var f=new qi(a);Q(Ei,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=G("PLAYBACK_ID"))&&(d.plid=a);(a=G("EVENT_ID"))&&(d.ei=a);c&&nq(c,d);Od("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Rb:h,S:d,ba:function(a,b){var c=b.response;Q(Gi,f);c.actions&&Kp(c.actions)},
Nb:function(){Q(Fi,f)}})}
function hq(a,b,c,d){if(null!==b||null!==c){var e={};a&&(e.channel_id=a);null===b||(e.email_on_upload=b);null===c||(e.receive_no_updates=c);Od("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",S:e,onError:function(){d&&d()}})}}
function dq(a){if(a.length){var b=Ua(a,0,40);Q("subscription-batch-subscribe-loading");mq(b,zi);var c={};c.a=b.join(",");var d=function(){Q("subscription-batch-subscribe-loaded");mq(b,Ai)};
...
function fq(a){if(a.length){var b=Ua(a,0,40);Q("subscription-batch-unsubscribe-loading");mq(b,Ei);var c={};c.c=b.join(",");var d=function(){Q("subscription-batch-unsubscribe-loaded");mq(b,Fi)};
Od("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",S:c,ba:function(){d();mq(b,Gi);a.length&&fq(a)},
onError:function(){d()}})}}
function mq(a,b){z(a,function(a){Q(b,new qi(a))})}
function nq(a,b){var c=Fd(a),d;for(d in c)b[d]=c[d]}
;var oq,pq=null,qq=null,rq=null,sq=!1;
function tq(){var a=G("PLAYER_CONFIG",void 0);if("1"!=a.privembed)try{var b;try{var c=r("yt.www.ads.biscotti.getId_"),d;if(c)d=c();else{if(!Ep){var e=w(Ip,l,2);Ep=Bp().then(Fp,e)}d=Ep}b=d}catch(f){b=gg(f)}hg(b,null,Jp,void 0)}catch(f){bc(f)}if(G("REQUEST_POST_MESSAGE_ORIGIN")){if(!oq){oq=new jj;oq.b=tq;return}oq.origin&&"*"!=oq.origin&&(a.args.post_message_origin=oq.origin)}d=document.referrer;b=G("POST_MESSAGE_ORIGIN");c=!1;Zf("legacy_cast2")&&v(d)&&v(b)&&-1<d.indexOf(b)&&eh(b)&&eh(d)&&(c=!0);window!=
window.top&&d&&d!=document.URL&&(a.args.loaderUrl=d);G("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Ij(a.args);pq=di("player",a);d=G("POST_MESSAGE_ID","player");G("ENABLE_JS_API")?rq=new vp(pq):G("ENABLE_POST_API")&&v(d)&&v(b)&&(qq=new xp(window.parent,d,b),rq=new rp(pq,qq.f));Zf("legacy_cast2")&&((sq=c&&!G("ENABLE_CAST_API"))?a.args.disableCast="1":(a=pq,wo(),Yo=a,Yo.addEventListener("onReady",$o),Yo.addEventListener("onRemoteReceiverSelected",bp),Zo.push(kc("yt-remote-receiver-availability-change",
ap)),Zo.push(kc("yt-remote-auto-connect",cp))));G("BG_P")&&(G("BG_I")||G("BG_IU"))&&zc();Yd();dp=pq;dp.addEventListener("SUBSCRIBE",gp);dp.addEventListener("UNSUBSCRIBE",jp);ep.push(ph(Bi,kp),ph(Gi,lp))}
...
q("writeEmbed",tq,void 0);q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a+="mac_204?action_fcts=1")&&hh(a);return!0},void 0);
var uq=ac(function(){Ah("ol");Wp=!0;Yp.push(ph(yi,Zp),ph(Di,aq));Wp||(Yp.push(ph(Ci,Zp),ph(Hi,aq),ph(vi,cq),ph(wi,eq),ph(xi,gq)),Xp.push(kc("subscription-prefs",iq)),Yp.push(ph(Sp,jq),ph(Up,lq),ph(Rp,kq)));rf.getInstance();var a=1<window.devicePixelRatio;if(wf(0,119)!=a){var b="f"+(Math.floor(119/31)+1),c=vf(b)||0,c=a?c|67108864:c&-67108865;0==c?delete sf[b]:(a=c.toString(16),sf[b]=a.toString());var b=[],d;for(d in sf)b.push(d+"="+escape(sf[d]));Re("PREF",b.join("&"),63072E3)}}),vq=ac(function(){var a=
pq;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();G("PL_ATT")&&(yc=null);for(var a=0,b=Wd.length;a<b;a++){var c=Wd[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):I(c)}}Wd.length=0;a=uc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))pc(a),b.parentNode.removeChild(b);Xd=!1;Zb("DCLKSTAT",0);mc(Xp);Xp.length=0;qh(Yp);Yp.length=0;Wp=!1;dp&&(dp.removeEventListener("SUBSCRIBE",hp),dp.removeEventListener("UNSUBSCRIBE",jp));dp=null;qh(ep);ep.length=0;
Zf("legacy_cast2")&&!sq&&(mc(Zo),Zo.length=0,Yo&&(Yo.removeEventListener("onRemoteReceiverSelected",bp),Yo.removeEventListener("onReady",$o),Yo=null),Ko());Vb(rq,qq);pq&&pq.destroy()});
window.addEventListener?(window.addEventListener("load",uq),window.addEventListener("unload",vq)):window.attachEvent&&(window.attachEvent("onload",uq),window.attachEvent("onunload",vq));var wq=dj.getInstance(),xq=R(wq);xq in ij||(wq.register(),wq.pb.push(kc("yt-uix-init-"+xq,wq.init,wq)),wq.pb.push(kc("yt-uix-dispose-"+xq,wq.dispose,wq)),ij[xq]=wq);})();

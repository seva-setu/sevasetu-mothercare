      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5><?php echo trans('routes.view')." ".trans('routes.callchampion'); ?></h5>
          </div>
          <div class="widget-content ">
         <table class="table table-bordered table-striped">
          <tbody>
           <tr>
              <td align="center" style="font-weight: 600;" colspan="2"><?php echo trans('routes.callchampion')." ".trans('routes.detail'); ?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><?php echo trans('routes.motherhood'); ?></td>
              <td><?php echo $result->e_motherhood_status; ?></td>
            </tr>
            <tr>
            ...
            <a class="btn btn-info" href="<?php echo Config::get('app.url').'admin/callchampions/edit/'.Hashids::encode($result->bi_id) ?>"><i class="icon-edit icon-white"></i><?php echo trans('routes.edit'); ?></a>
			<!-- a class="btn btn-danger" onclick="return singleCheckDel();" href="<?php echo Config::get('app.url').'admin/callchampions/delete/'.Hashids::encode($result->bi_id)."/".Hashids::encode($result->bi_user_login_id); ?>"><i class="icon-remove icon-white"></i><?php echo trans('routes.delete'); ?></a> -->
			<?php if($result->e_status=="Active"){?>
            	<a class="btn btn-info" href="<?php echo Config::get('app.url').'admin/callchampions/delete/'.Hashids::encode($result->bi_id)."/".Hashids::encode($result->bi_user_login_id)."/".Hashids::encode(0); ?>"></i><?php echo trans('routes.inactive'); ?></a>					  	
            <?php }elseif($result->e_status=="Inactive"){?>
            	<a class="btn btn-info" href="<?php echo Config::get('app.url').'admin/callchampions/delete/'.Hashids::encode($result->bi_id)."/".Hashids::encode($result->bi_user_login_id)."/".Hashids::encode(1); ?>"></i><?php echo trans('routes.active'); ?></a>					  	
            <?php }?>
            ...
            <?php }?>
            <a href="<?php echo Config::get('app.url');?>admin/callchampions" class="btn btn-primary"><?php echo trans('routes.back'); ?></a></td>
            </tr>
          </tbody>
        </table>
          </div>

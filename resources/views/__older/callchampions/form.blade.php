<?php 
if($action=="add")
	$callaction= trans('routes.add');
else
	$callaction= trans('routes.edit');
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
            <h5><?php echo $callaction;?> <?php echo trans('routes.callchampion'); ?></h5>
          </div>
          <form class="form-horizontal" role="form" method="POST" id="frmCallChampion" enctype="multipart/form-data" name="frmCallChampion" action="<?php echo Config::get('app.url').'admin/callchampions/'.$action; ?>">
              ...
              <div class="row-fluid">
                  <div class="span12 clearfix">
                    ...
                    <div class="control-group">
                      ...
                      <?php foreach ($languagedata as $lang){
                      	...
                      	<label class="checkbox-custome">
                      	 <input type='checkbox' class="checkbox" name='txtLanguage[]' <?php echo $check; ?> value='<?php echo $lang->bi_id; ?>'><?php echo ucwords($lang->v_language); ?><br>
    				  </label>
    				   <?php }?>
    				   </div><br/>
                    ...
                    <div class="control-group">
                     ...
                     <div class="control-group">
                    <label for="txtProfilePic" class="col-sm-4 control-label"><?php echo trans('routes.imagelabel'); ?></label>
                  ...
                  <div class="col-sm-2" style="text-align: center;" >
                    	<div class="fileUpload btn btn-primary">
    						...
    						<input type="file" id="txtProfilePic" name="txtProfilePic" class="upload"  />
						</div>
                    </div>
                  ...
                  <label for="txtProfilePic" generated="true" class="error"></label>
                    ...
                    <div class="control-group" id="bName">
                     ...
                     <div class="control-group">
                      ...
                      <div class="controls">
                      	  <input type="text" maxlength="20" name="txtProfession" id="txtProfession" value="<?php echo $result->v_profession; ?>">
                       </div>
                    </div>
                       <div class="control-group">
                ...
                <div class="form-actions">
                  <div class="splitFormSubmitButton">
                    ...
                    <?php }?>
                    <a href="<?php echo Config::get('app.url'); ?>admin/callchampions" class="btn btn-danger"><?php echo trans('routes.cancel'); ?></a>
                  </div>
                </div>
            </div>
          </div>

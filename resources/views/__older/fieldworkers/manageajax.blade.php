              	...
              	?>
			        <tr>
                      <td><input type="checkbox" name="chkCheckedBox[]" id="chkCheckedBox" value="<?php echo $value->bi_id; ?>_<?php echo $value->bi_user_login_id; ?>" /></td>
                      	<td><a href="<?php echo Config::get('app.url').'admin/fieldworkers/view/'.Hashids::encode($value->bi_id) ?>"><?php echo $value->v_unique_code;?></a></td>
                        <td><a href="<?php echo Config::get('app.url').'admin/fieldworkers/view/'.Hashids::encode($value->bi_id) ?>"><?php echo $value->v_name;?></a></td>
						...
						<td><?php echo $value->v_phone_number;?></td>
					  	...
					  	<td style="width: 230px" >
					  		<a class="btn btn-info" href="<?php echo Config::get('app.url').'admin/fieldworkers/edit/'.Hashids::encode($value->bi_id) ?>"><i class="icon-edit icon-white"></i><?php echo trans('routes.edit'); ?></a>

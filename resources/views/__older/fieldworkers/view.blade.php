...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="<?php echo Config::get('app.url'); ?>admin/dashboard" title="<?php echo trans('routes.homelabel'); ?>" class="tip-bottom"><i class="icon-home"></i> <?php echo trans('routes.home'); ?></a><a href="<?php echo Config::get('app.url'); ?>admin/fieldworkers"><?php echo trans('routes.fieldworker'); ?></a><a class="current"><?php echo trans('routes.view'); ?></a></div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5><?php echo trans('routes.view')." ".trans('routes.fieldworker'); ?></h5>
          </div>
          <div class="widget-content ">
         <table class="table table-bordered table-striped">
          <tbody>
             <tr>
              <td align="center" style="font-weight: 600;" colspan="2"><?php echo trans('routes.fieldworker')." ".trans('routes.detail'); ?></td>
            </tr>
            <tr>
            ...
            <tr >
            <td colspan="2">
            <a class="btn btn-info" href="<?php echo Config::get('app.url').'admin/fieldworkers/edit/'.Hashids::encode($result->bi_id) ?>"><i class="icon-edit icon-white"></i><?php echo trans('routes.edit'); ?></a>
			<!--  a class="btn btn-danger" onclick="return singleCheckDel();" href="<?php echo Config::get('app.url').'admin/fieldworkers/delete/'.Hashids::encode($result->bi_id)."/".Hashids::encode($result->bi_user_login_id); ?>"><i class="icon-remove icon-white"></i><?php echo trans('routes.delete'); ?></a>-->
            <?php if($result->e_status=="Active"){?>
            	<a class="btn btn-info" href="<?php echo Config::get('app.url').'admin/fieldworkers/delete/'.Hashids::encode($result->bi_id)."/".Hashids::encode($result->bi_user_login_id)."/".Hashids::encode(0); ?>"></i><?php echo trans('routes.inactive'); ?></a>					  	
            <?php }elseif($result->e_status=="Inactive"){?>
            	<a class="btn btn-info" href="<?php echo Config::get('app.url').'admin/fieldworkers/delete/'.Hashids::encode($result->bi_id)."/".Hashids::encode($result->bi_user_login_id)."/".Hashids::encode(1); ?>"></i><?php echo trans('routes.active'); ?></a>					  	
            <?php }?>
            ...
            <a href="<?php echo Config::get('app.url');?>admin/fieldworkers" class="btn btn-primary"><?php echo trans('routes.back'); ?></a></td>
            </tr>
          </tbody>
        </table>
          </div>

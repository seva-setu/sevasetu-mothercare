<?php 
if($action=="add")
	$fieldlabel= trans('routes.add');
else
	$fieldlabel= trans('routes.edit');
...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="<?php echo Config::get('app.url'); ?>admin/dashboard" title="<?php echo trans('routes.homelabel'); ?>" class="tip-bottom"><i class="icon-home"></i><?php echo trans('routes.home'); ?></a><a href="<?php echo Config::get('app.url'); ?>admin/fieldworkers"><?php echo trans('routes.fieldworker'); ?></a><a class="current"><?php echo $fieldlabel;?></a></div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
            <h5><?php echo $fieldlabel;?> <?php echo trans('routes.fieldworker'); ?></h5>
          </div>
          <form class="form-horizontal" role="form" method="POST" id="frmCallChampion" enctype="multipart/form-data" name="frmCallChampion" action="<?php echo Config::get('app.url').'admin/fieldworkers/'.$action; ?>">
              ...
              <div class="row-fluid">
                ...
                <div class="form-actions">
                  <div class="splitFormSubmitButton">
                    ...
                    <?php }?>
                    <a href="<?php echo Config::get('app.url');?>admin/fieldworkers" class="btn btn-danger"><?php echo trans('routes.cancel'); ?></a>
                  </div>
                </div>
            </div>
          </div>

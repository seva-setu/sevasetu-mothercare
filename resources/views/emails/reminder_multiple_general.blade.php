...
<body>
<p>Hi {{$cc_name}}</p>
<p>This is to remind you that you have {{$count}} calls scheduled. Please login to the <a href="http://sevasetu.org/mother_care">Mother Care portal</a> with your credentials to view the full list.

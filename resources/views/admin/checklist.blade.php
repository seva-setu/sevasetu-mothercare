                  ...
                  <div class="span12 clearfix">
                      ...
                      <div class="controls">
                     	<select class="form-control required" id="sltCategory" name="sltCategory">
                     		...
                     		@foreach($categories as $category)
                     			<option value="{{ $category->bi_id or '' }}" @if(Input::old('sltCategory')==$category->bi_id) {{ "selected='selected'" }}  @endif >{{ $category->v_type or '' }}</option>
                     		@endforeach
                     	</select> 	
                   ...
                   --}}
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                     	<input type="text" class="form-control required" maxlength="100" name="description" value="{{ Input::old('description') }}" id="description">                    	  
                       @if($errors->first('Description')) <p class="errmsg">{{ $errors->first('Description') }}</p> @endif
                     </div>
                    </div>
                                
                {{--     <div class="control-group">
                      <label class="control-label">{{ trans('routes.recommendtype') }}</label>
                      <div class="controls">
                     	<input type="radio" name="rdDefined" value='defined' @if(!Input::old('rdDefined') || Input::old('rdDefined')=="defined") {{ "checked" }}  @endif > {{ trans('routes.defined') }}
                     	<input type="radio" name="rdDefined" value='custom' @if(Input::old('rdDefined')=="custom") {{ "checked" }}  @endif> {{ trans('routes.noinput') }}
                     </div>
                    </div> --}}
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                      	  <input type="text"  maxlength="100" name="recommended_time" @if(Input::old('rdDefined')=="custom") {{ "disabled" }} @endif id="recommended_time" value="{{ Input::old('recommended_time') }}">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls" id="dynamicOption">
                          	<input type="text" maxlength='50' placeholder='Option 1' id="optionText1" class="optionText required" class="form-control">
                      </div>
                       <div class="controls">
                     ...
                     <div class="controls">
                      ...
                      <div class="controls">
                     	<select class="form-control required" id="sltForType" name="sltForType">
                     		...
                     		<option value="0"  @if(Input::old('sltForType')=="0") {{ "selected='selected'" }}  @endif >Mother</option>
                     		<option value="1"  @if(Input::old('sltForType')=="1") {{ "selected='selected'" }}  @endif >Baby</option>
                     	</select> 	
...
<script>
	$(document).ready(function(){
		...
		// Submit Form but merge optioncs first
